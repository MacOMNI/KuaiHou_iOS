...
//    [self addSubview:_maxLabel];
    ...
    minSliderButton.layer.borderColor = kMainColor.CGColor;
    ...
    maxSliderButton.layer.borderColor = kMainColor.CGColor;
...
- (void)valueMinChange:(CGFloat)num
{
    ...
    if (self.minValueBlock) {
        self.minValueBlock(_currentMinValue);
    }
}
...
- (void)valueMaxChange:(CGFloat)num
{
    ...
    if (self.maxValueBlock) {
        self.maxValueBlock(_currentMaxValue);
    }
