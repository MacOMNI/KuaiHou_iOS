//
//  UILabel+BaseChangeDefaultFont.m
//  KuaiHou_iOS
//
...
#import "UILabel+BaseChangeDefaultFont.h"
#import <objc/runtime.h>

@implementation UILabel (BaseChangeDefaultFont)
...
- (instancetype)YHBaseInit
{
    ...
    UIFont * font = [UIFont fontWithName:@"PingFangSC-Medium" size:self.font.pointSize];
    if (font) {
        self.font=font;
    }
    return __self;
